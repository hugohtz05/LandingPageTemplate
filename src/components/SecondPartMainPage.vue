  ...
  <main>
    <nav>
      <div class="xxs:flex xxs:justify-center">
        <img
          class="absolute xxs:mt-[56px] xxs:w-[auto] xxs:h-[402px] xxs:z-10"
          src="/src/assets/image-jeremy-large.png"
          alt=""
        />
        <img
          class="absolute xxs:h-[402px] xxs:m-[120px]"
      ...
      <div class="xxs:flex xxs:justify-center">
        <div
          class="bg-blue rounded-[15px] xxs:mt-[237px] xxs:flex xxs:flex-col xxs:items-center xxs:h-[748px] xxs:w-[375px]"
        >
          <img
          ...
          <p
            class="font-Epilogue text-cream xxs:w-[343px] xxs:h-[160px] xxs:text-[18px] xxs:leading-[32px] xxs:tracking-[0.09px] xxs:mb-[40px]"
          >
